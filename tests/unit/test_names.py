...
class TestAddNamesColumns:
    ...
    def test_add_names_columns_single_code_column(self, mock_get_mapping, sample_mock_mapping):
    ...
    @patch("oda_data.tools.names.add.get_merged_names_mapping")
    def test_add_names_columns_multiple_code_columns(self, mock_get_mapping, sample_mock_mapping):
    ...
    @patch("oda_data.tools.names.add.get_merged_names_mapping")
    def test_add_names_columns_with_empty_dataframe(self, mock_get_mapping, sample_mock_mapping):
    ...
    @patch("oda_data.tools.names.add.get_merged_names_mapping")
    def test_add_names_columns_raises_error_for_unmapped_column(
...
class TestAddNamesColumnsIntegration:
    ...
    def test_add_names_columns_complete_workflow(
        ...
        result = add_names_columns(
            df, ["donor_code", "recipient_code", "sector_code"]
        )
