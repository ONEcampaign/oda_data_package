...
class ODASchema:
    ...
    MEASURE: str = "measure"
    INITIAL_REPORT: str = "initial_report"
    DE_INCOMEGROUPCODE: str = "de_incomegroupcode"
    CHANNEL_REPORTED_NAME: str = "channel_reported_name"
...
CORE_CRS_MAPPING: dict[str, str] = {
    ...
    "crs_id": ODASchema.CRS_ID,
    "initial_report": ODASchema.INITIAL_REPORT,
    ...
    "de_incomegroupcode": ODASchema.DE_INCOMEGROUPCODE,
    ...
    "purpose_name": ODASchema.PURPOSE_NAME,
    "sector_name": ODASchema.SECTOR_NAME,
    ...
    "channel_reported_name": ODASchema.CHANNEL_REPORTED_NAME,
    "geography": ODASchema.GEOGRAPHY,
    "keywords": ODASchema.KEYWORDS,
    "climate_adaptation": ODASchema.ADAPTATION,
...
CRS_MAPPING: dict[str, str] = CORE_CRS_MAPPING | {
    "year": ODASchema.YEAR,
    "donor_code": ODASchema.PROVIDER_CODE,
    "donor_name": ODASchema.PROVIDER_NAME,
