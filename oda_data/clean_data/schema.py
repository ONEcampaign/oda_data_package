...
class AidDataSchema:
    ...
    IMPLEMENTATION_START_YEAR: str = "implementation_start_year"
    ...
    VALUE_ORIGINAL_CURRENCY: str = "value_original_currency"
    ORIGINAL_CURRENCY: str = "original_currency"
    VALUE_ESTIMATED: str = "value_estimated"
    VALUE_CONSTANT_USD_2021: str = "value_constant_usd_2021"
    VALUE_CURRENT_USD: str = "value_current_usd"
    ADJUSTED_VALUE_ORIGINAL_CURRENCY: str = "adjusted_value_original_currency"
    ADJUSTED_VALUE_CONSTANT_USD_2021: str = "adjusted_value_constant_usd_2021"
    ADJUSTED_VALUE_CURRENT_2021: str = "adjusted_value_current_2021"
    FINANCIAL_DISTRESS: str = "financial_distress"
    COMMITMENT_DATE: str = "commitment_date"
    COMMITMENT_DATE_ESTIMATED: str = "commitment_date_estimated"
    PLANNED_IMPLEMENTATION_DATE: str = "planned_implementation_date"
    ACTUAL_IMPLEMENTATION_DATE: str = "actual_implementation_date"
    ACTUAL_IMPLEMENTATION_DATE_ESTIMATED: str = "actual_implementation_date_estimated"
    DEVIATION_PLANNED_ACTUAL_IMPLEMENTATION_DATE: str = "deviation_planned_actual_implementation_date"
    PLANNED_COMPLETION_DATE: str = "planned_completion_date"
    ACTUAL_COMPLETION_DATE: str = "actual_completion_date"
    ACTUAL_COMPLETION_DATE_ESTIMATED: str = "actual_completion_date_estimated"
    DEVIATION_PLANNED_ACTUAL_COMPLETION_DATE: str = "deviation_planned_actual_completion_date"
    ...
    INSURANCE_FEE_CURRENT_USD: str = "insurance_fee_current_usd"
    DEFAULT_INTEREST_RATE: str = "default_interest_rate"
    FIRST_LOAN_REPAYMENT_DATE: str = "first_loan_repayment_date"
    LAST_LOAN_REPAYMENT_DATE: str = "last_loan_repayment_date"
    GRANT_ELEMENT_FLOW: str = "grant_element_flow"
    GRANT_ELEMENT_GRANT_EQUIVALENT: str = "grant_element_grant_equivalent"
